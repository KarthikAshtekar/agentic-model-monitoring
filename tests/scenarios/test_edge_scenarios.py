...
def test_edge_scenario_features_generate_reproducibly(
    ...
    scenario_dir = tmp_path / "data/scenarios/credit_default" / scenario_name
...
def test_unlabelled_drift_has_no_labels_file(tmp_path, monkeypatch) -> None:
    ...
    scenario_dir = tmp_path / "data/scenarios/credit_default/unlabelled_drift"
...
def test_insufficient_labels_has_exact_aligned_subset(tmp_path, monkeypatch) -> None:
    ...
    scenario_dir = tmp_path / "data/scenarios/credit_default/insufficient_labels"
